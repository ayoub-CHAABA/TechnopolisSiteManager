 ...
 * @author ragragui
 */
public class ModifierRole extends javax.swing.JFrame {
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        GestionRole sa=new GestionRole();
        sa.setVisible(true);
...
jt.setModel(model);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierRole.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifierRole().setVisible(true);
            }
        });
    }
