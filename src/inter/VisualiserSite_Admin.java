 ...
 * @author ragragui
 */
public class VisualiserSite_Admin extends javax.swing.JFrame {

    /**
     * Creates new form ModifierSite
     */
    public VisualiserSite_Admin() {
        initComponents();
    }
...
jt.setModel(model);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualiserSite_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualiserSite_Admin().setVisible(true);
            }
        });
    }
