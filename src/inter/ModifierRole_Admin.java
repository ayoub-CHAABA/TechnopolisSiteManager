 ...
 * @author ragragui
 */
public class ModifierRole_Admin extends javax.swing.JFrame {

    /**
     * Creates new form ModifierSite
     */
    public ModifierRole_Admin() {
        initComponents();
    }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        GestionRole_1 sa=new GestionRole_1();
        sa.setVisible(true);
...
jt.setModel(model);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierRole_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifierRole_Admin().setVisible(true);
            }
        });
    }
